...
import WeeklyProgressScreen from '../../src/screens/WeeklyProgressScreen';
...
describe('WeeklyProgressScreen Component (RNTL)', () => {
    ...
    beforeEach(() => {
        ...
        mockUseProgressController.mockReturnValue({
            ...
            fetchWeeklyProgressByDate: jest.fn(),
        } as any);
    });

    it('renders weekly progress screen title and stats', async () => {
        const { getByText } = await render(
            <AuthContext.Provider value={{ user: { id: 'u1' } } as any}>
                <WeeklyProgressScreen navigation={mockNavigation} />
